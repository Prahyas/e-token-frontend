...
const EditTokenModal = ({ open, setopen, id, attributes, updateTokens }) => {
  ...
  const [editTokenData, seteditTokenData] = useState({
    service: null,
    totaltokens: attributes.totaltokens,
    singletoken: attributes.singletoken,
  });

  useEffect(() => {
    console.log('edittokendata', attributes);
  }, [attributes]);
        ...
        <div class='relative px-4 w-full max-w-2xl h-full md:h-auto pt-5'>
          <div class='relative bg-white rounded-lg shadow dark:bg-gray-700'>
            ...
            <div class='p-6 space-y-6'>
              <form>
                ...
                <div class='mb-2'>
                  ...
                  <input
                    type='text'
                    value={editTokenData.totaltokens}
                    onChange={(e) =>
                      seteditTokenData({
                        ...editTokenData,
            ...
            <div class='flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600'>
              <button
                onClick={() => {
                  updateTokens(id, editTokenData), setopen(false);
                }}
                type='button'
                ...
                disabled={!editTokenData.service || !editTokenData.totaltokens}
              >
                Edit
              </button>
              <button
